*&---------------------------------------------------------------------*
*& Report Z1014304_MPP_TABLE_WIZAD
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT Z1014304_MPP_TABLE_WIZAD.
...
***&SPWIZARD: DATA DECLARATION FOR TABLECONTROL 'TABLE'
*&SPWIZARD: DEFINITION OF DDIC-TABLE
TABLES:   VBAK.

*&SPWIZARD: TYPE FOR THE DATA OF TABLECONTROL 'TABLE'
...
*&SPWIZARD: INTERNAL TABLE FOR TABLECONTROL 'TABLE'
...
CONTROLS: TABLE TYPE TABLEVIEW USING SCREEN 0900.

*&SPWIZARD: LINES OF TABLECONTROL 'TABLE'
...
*&SPWIZARD: INTO INTERNAL TABLE 'g_TABLE_itab'
    SELECT * FROM VBAK
       INTO CORRESPONDING FIELDS
       OF TABLE G_TABLE_ITAB.
    G_TABLE_COPIED = 'X'.
    REFRESH CONTROL 'TABLE' FROM SCREEN '0900'.
  ENDIF.
ENDMODULE.
...
MODULE TABLE_MOVE OUTPUT.
  MOVE-CORRESPONDING G_TABLE_WA TO VBAK.
ENDMODULE.
...
*&SPWIZARD: INPUT MODULE FOR TC 'TABLE'. DO NOT CHANGE THIS LINE!
