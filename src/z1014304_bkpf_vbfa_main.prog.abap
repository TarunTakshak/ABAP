...
FORM get_bkpf_vbfa .
  ...
  IF sy-subrc <> 0 AND it_vbfa IS INITIAL.
...
FORM get_bkpf .
  ...
  IF sy-subrc <> 0 AND it_bkpf IS INITIAL.
  ...
  ELSE.
    LOOP AT it_vbfa INTO wa_vbfa.
      ...
      READ TABLE it_bkpf INTO wa_bkpf WITH KEY belnr = wa_vbfa-vbeln.
      IF sy-subrc = 0.
